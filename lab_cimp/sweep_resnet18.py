...
def run_2d_sweep(size):
    ...
    temp_hw = f"lab_cimp/inputs/hardware/cimp_2D_sweep_rn18.yaml"
    ...
    try:
        energy, latency, tclk, area, res = get_hardware_performance_zigzag(
            ...
            dump_folder=f"lab_cimp/outputs/sweep_rn18_2D_{size}",
            pickle_filename=f"lab_cimp/outputs/sweep_rn18_2D_{size}.pickle",
...
def run_3d_sweep(d1, d2, d3):
    ...
    temp_hw = f"lab_cimp/inputs/hardware/cimp_3D_sweep_rn18.yaml"
    ...
    try:
        energy, latency, tclk, area, res = get_hardware_performance_zigzag(
            accelerator=temp_hw, workload=workload, mapping=mapping,
            temporal_mapping_search_engine="loma", opt="latency",
            dump_folder=f"lab_cimp/outputs/sweep_rn18_3D_{d1}",
            pickle_filename=f"lab_cimp/outputs/sweep_rn18_3D_{d1}.pickle",
            in_memory_compute=True, loma_show_progress_bar=False,
        )
...
print("\n=== ResNet-18 Real Workload: 2D vs 3D Comparison Table ===")
