...
accelerator = "lab_cimp/inputs/hardware/cimp_2D.yaml"

# --- WORKLOAD PATH TOGGLE: uncomment ONE of the two lines below ---
#workload = "lab_cimp/inputs/workload/full_utilization.yaml"    # <-- YAML manual 3D workload
...
mapping = "lab_cimp/inputs/mapping/mapping.yaml"   # <-- Auto-search spatial mapping
...
save_path = "lab_cimp/outputs/breakdown_2D.png"
...
logger.info("=== ZigZag System-Level Metrics (2D) ===")
...
logger.info("=== 2D CIMP Analyser Verification [%s] ===", imc_macro.tech_param.get("cimp_manufacturing_tech", "unknown"))
cell_array_area_mm2 = (imc_macro.wordline_dim_size * imc_macro.bitline_dim_size * imc_macro.cells_area) / 1e6
